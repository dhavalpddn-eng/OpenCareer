...
3. Add verified aircraft enrichment for payload, dispatch weight/fuel limits, payload-range data, cruise, IFR, pressurization and runway traits; missing values remain unknown.
