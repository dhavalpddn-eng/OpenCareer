...
- Still open: user-facing Settings restore selection/confirmation, communications/deeper Military/Government drill-down, local visual/accessibility acceptance, authoritative career/dispatch/job settlement integration, large balance/stress runs and live telemetry gameplay verification.
