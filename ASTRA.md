...
## Built
**Parallel conflict foundation (PR #10):** deterministic ground/air conflict, multi-family missions, abstract effects/threat damage, qualification/assignment authorization, fictional theater generation, SQLite campaign recovery, strategic campaign evolution, persistent player-operation state and a UI-ready operations projection are implemented on `feature/military-conflict-system`. Automatic startup recovery, SQLite-consistent backup/restore, deterministic fictional operation/faction identity, the UI-ready operations projection, and a first bounded long-term campaign-cycle layer are implemented. A user-facing restore picker/confirmation, deeper reinforcement/operation/faction evolution, main-career/fleet/job/economy integration, production Military/Government UI and live gameplay verification remain.
