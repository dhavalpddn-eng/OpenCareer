...
**Parallel military branch:** `feature/military-conflict-system`, draft PR #10 -> `feature/m1-simulation-core`; deterministic ground/air conflict, CAS/suppression/recon/logistics/patrol/escort/intercept mission lifecycles, military authorization, seeded fictional theater generation, and SQLite conflict-campaign checkpoints are implemented there. Earlier military code is CI-green at `6089371`; the newest persistence slice through `aec8fdfe` still needs a fresh run.  
