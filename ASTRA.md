...
## Built
**Parallel conflict foundation (PR #10):** deterministic ground/air conflict, multi-family missions, abstract effects/threat damage, qualification/assignment authorization, fictional theater generation, SQLite campaign recovery, strategic campaign evolution, persistent player-operation state and a UI-ready operations projection are implemented on `feature/military-conflict-system`. Automatic startup recovery, SQLite-consistent backup/restore, deterministic fictional operation/faction identity, deterministic faction postures (Defensive/Aggressive/LogisticsFocused/AirFocused), UI-ready operations projection, bounded campaign cycles, finite logistics-gated replacements, terminal Victory/Defeat/Stalemate/Ceasefire outcomes, persistent completed-operation history, deterministic successor planning, and an application-layer successor offer/accept/decline/reconsider flow are implemented. A user-facing restore picker/confirmation, Military/Government successor-offer presentation, optional dynamic posture changes across later campaign phases, main-career/fleet/job/economy integration, production Military/Government UI and live gameplay verification remain.
