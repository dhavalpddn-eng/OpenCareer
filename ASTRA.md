...
**Parallel military branch:** `feature/military-conflict-system`, draft PR #10 -> `feature/m1-simulation-core`; deterministic ground/air conflict, all current military mission families, authorization, fictional theater generation, SQLite campaign/mission recovery, strategic phase/momentum/objectives, persisted threat outcomes, dispatch authorization and the Military/Government snapshot projection are implemented there. Linux is green through `ddcf31b2` at 227/227 xUnit + 29/29 SimLab; Windows is green through `f9aac31b` with WinUI/probe builds + 226/226 xUnit.  
