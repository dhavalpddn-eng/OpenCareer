...
**Parallel military branch:** `feature/military-conflict-system`, draft PR #10 -> `feature/m1-simulation-core`; deterministic ground/air conflict, all current military mission families, authorization, fictional theater generation, SQLite campaign/mission recovery, strategic phase/momentum/objectives, persisted threat outcomes, dispatch authorization and the Military/Government snapshot projection are implemented there. Current military code head `b4e3ca81` is green: Linux 376/376 xUnit + 29/29 SimLab; Windows WinUI/live-probe builds at 0 errors + 376/376 xUnit.
