...
**Parallel military branch:** `feature/military-conflict-system`, draft PR #10 -> `feature/m1-simulation-core`; deterministic ground/air conflict, CAS/suppression/recon/logistics/patrol/escort/intercept mission lifecycles, military authorization, and seeded fictional theater generation are implemented there. Latest CI verification is pending after branch sync/fixes.  
